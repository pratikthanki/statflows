...
class GameBoxScoreSchema(Schema):
    class Meta:
        fields = (
            'Game', 'GameID', 'BoxScoreBreakdown', 'HomeTeamCode', 'HomeTeamName', 'HomeTeamNickname', 'AwayTeamCode',
...
class PlayerGameSummarySchema(Schema):
    class Meta:
        fields = (
            'Ast', 'Blk', 'Blka', 'Court', 'Dreb', 'Fbpts', 'Fbptsa', 'Fbptsm', 'Fga', 'Fgm', 'Fn', 'Fta', 'Ftm',
            'GameID', 'Ln', 'Memo', 'Mid', 'Min', 'Num', 'Oreb', 'Pf', 'PlayerID', 'Pip', 'Pipa', 'Pipm', 'Pm',
            'Pos', 'Pts', 'Reb', 'Sec', 'Status', 'Stl', 'Ta', 'Tf', 'TeamID', 'Totsec', 'Tov', 'Tpa', 'Tpm', 'Id')


class GamePlaysSchema(Schema):
    class Meta:
        fields = (
            'ClockTime', 'Description', 'EPId', 'EType', 'Evt', 'GameID', 'HS', 'LocationX', 'LocationY', 'MId',
            'MType', 'OftId', 'OpId', 'Opt1', 'Opt2', 'Ord', 'Period', 'PlayerID', 'TeamID', 'Vs', 'Id')
